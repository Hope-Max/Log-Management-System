		...
		<Fragment>
			<Col sm="12">
				<Card className="hovercard text-center">
					...
					<UserImageIcon url={url} readUrl={(e) => readUrl(e)} />
					<div className="info">
						...
						<div className="social-media step4" data-intro="This is your Social details">
							<UL
								attrUL={{
									horizontal: true,
									className: 'simple-list list-inline d-flex justify-content-center simple-list'
								}}
							>
			...
			<div className="avatar">
				<Image
					attrImage={{
						className: 'step1',
						alt: '',
						src: `${props?.url ? props?.url : require('../../../assets/images/user/7.jpg')}`
					}}
				/>
			</div>
			<div className="icon-wrapper step2" data-intro="Change Profile image here">
				<i className="icofont icofont-pencil-alt-5" onChange={(e) => props?.readUrl(e)}>
					<input className="upload" type="file" onChange={(e) => props?.readUrl(e)} />
				</i>
			</div>
		</div>
	);
