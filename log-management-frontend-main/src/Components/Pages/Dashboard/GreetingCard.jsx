...
import { H4, H5, P, Btn, Image } from '../../../AbstractElements';
import CarToon from '../../../assets/images/dashboard/cartoon.svg';
import { WelcomeToRevCorp, WelcomeMessage } from '../../../Data/Table/Defaultdata';
import { getCurrentHost, getCurrentUser } from '../../../redux/constants';
...
const GreetingCard = () => {
    ...
    const { timelogToday, error } = useSelector(
    ...
    return (
        <Col className='col-xxl-4 col-sm-6 box-col-6'>
            ...
            >
                {/* <CardBody>
                    <Media>
                        <Media body style={{ zIndex: '1' }}>
                            <div className='greeting-user'>
                                <H4 attrH4={{ className: 'f-w-600' }}>Welcome {getCurrentUser()?.first_name}</H4>
                                <P>{WelcomeMessage}</P>
                            </div>
                        </Media>
                        <div>
                        ...
                        <div className='cartoon' style={{ zIndex: '0' }}>
                            <Image attrImage={{ src: CarToon, alt: 'vector woman with laptop' }} />
                        </div>
                    </Media>
                </CardBody> */}
            </Card>
